...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function customize_mobile_menu_toggle() {
		return '<button class="menu-toggle icon is-hidden" aria-label="' . esc_html__( 'Open menu', 'wp-rig' ) . '" aria-controls="primary-menu" aria-expanded="false">
			<div class="hamburger">
				<span class="meat meat1"></span>
				<span class="meat meat2"></span>
				<span class="meat meat3"></span>
				<span class="meat meat4"></span>
				<span class="meat meat5"></span>
			</div>
		</button>';
	}
